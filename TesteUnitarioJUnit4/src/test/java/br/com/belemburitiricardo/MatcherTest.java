...
public class MatcherTest {
	...
	/*
	 * @Test public void givenCollection_checkEmpty() { List<String> emptyList = new
	 * ArrayList<String>(); assertThat(emptyList, Matchers.empty()); }
	 * 
	 * @Test public void givenAnInteger_checkGreater() { assertThat(1,
	 * Matchers.greaterThan(0)); }
	 * 
	 * @Test public void givenString_checkNull() { String str = null;
